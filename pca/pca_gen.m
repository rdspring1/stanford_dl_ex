...
while variance/total < 0.99
    variance = variance + eigenvalues(k);
    k = k + 1;
end
...
%%% YOUR CODE HERE %%%
xTiled = U(:,1:k)' * x; % reduced dimension representation of the data,  where k is the number of eigenvectors to keep
xHat = U * padarray(xTiled, size(x, 1)-k, 0, 'post');
